...
<!--                  	<span style="float:left;"><a href="http://www.importx.com/crm/c_register.jsp" class="btn btn-success"> Register</a></span> -->
                 	<span class="pull-right"><a href="#" class="btn btn-success" id="login" onclick="login()"> Login</a></span>
                 	<span class="pull-right"  style="margin-right: 20px;"><a href="https://importx.net/crm/c_register.jsp" style="color: #f0ad4e;line-height:30px;">Register</a></span>
                 	<span class="pull-right"  style="margin-right: 10px;"><a href="#"  onclick="recover_pwd();" style="color: #f0ad4e;line-height:30px;">Forget ?</a></span>               	
                </div>
            </form>
