...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-file"></i> Orders & Invoices</a>
   <ul id="sidebar_ul">
	    <li><a href="${ctx}/queryAllClientOrder.do"><i class="icon icon-file"></i> <span>My Orders</span></a> </li>
	
	    <li><a href="${ctx}/queryAllDrawings.do"><i class="icon icon-inbox"></i> <span>My Drawings</span></a></li>
	    
	    <li> <a href="${ctx}/queryAllQuotation.do"><i class="icon icon-group"></i> <span>Quotation</span> </a></li>
	    
	    <li> <a href="${ctx}/querySupplier.do"><i class="icon icon-group"></i> <span>My Supplier</span> </a></li>
	    
<!-- 	    <li> <a href="#" onclick="listMessage();"><i class="icon icon-group"></i> <span>Message Center</span> </a></li> -->
		
		<li> <a href="${ctx}/queryShippingInfo.do"><i class="icon icon-map-marker"></i> <span>My Account</span> </a></li>
