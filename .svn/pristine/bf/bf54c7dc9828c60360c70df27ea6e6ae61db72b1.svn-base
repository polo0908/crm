...
<%--                 <td>${clientDrawing.status}</td> --%>
                ...
                <td>
                <c:choose>
                <c:when test="${clientDrawing.drawingsName != null && clientDrawing.drawingsName != '' && clientDrawing.drawingsPath != null && clientDrawing.drawingsPath != ''}">
                <a class="a2" style="text-decoration:underline;color: #08c;cursor: pointer;" onclick="drawing_download('${clientDrawing.id}');">${clientDrawing.drawingsName}</a>
                </c:when>
                <c:otherwise>
                ${clientDrawing.drawingsName == null ? '' : clientDrawing.drawingsName}
                </c:otherwise>
                </c:choose>
                </td>
