...
public class RfqInfoController {
  ...
  public String uploadRfqInfo(HttpServletRequest request, HttpServletResponse response) throws Exception{
	  ...
	  try {
		  ...
		  Map<String, String> multiFileUpload = OperationFileUtil1.multiFileUpload(request, UploadAndDownloadPathUtil.getNewDrawingUpLoadAndDownLoadPath());		  
...
//		  else{
//			  drawingNameToTime = FilenameUtils.getName(drawingNameToTime);
//		  }
